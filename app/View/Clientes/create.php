    ...
    <div class="app-main__inner">
        ...
        <div class="card col-12">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <form method="POST" action="<?= RUTA_URL?>Clientes/Save">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="Apes" class="form-control" placeholder="Apellidos">
                            </div>
                            <div class="form-group">
                                <label>Estatura del cliente</label>
                                <input type="text" name="Estatura" class="form-control" placeholder="Estatura(mt)">
                            </div>
                            <div class="form-group">
                                <label>Peso del cliente</label>
                                <input type="text" name="peso" class="form-control" placeholder="Peso(lb)">
                            </div>
                            <div class="form-group">
